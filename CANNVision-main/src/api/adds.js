...
export const createAddsControlStates = ({
  blockCount = 4,
  blockLen = 2,
  srcStride = 0,
  dstStride = 0,
...
export const addsApiParameterDefinitions = [
  ...defaultApiParameterDefinitions,
  { id: 'scalarValue', label: 'scalar(标量值)', min: 0, max: 255, defaultValue: 10 },
];

export const addsApiDefinition = {
  id: 'adds',
  label: 'adds',
  createControlStates: createAddsControlStates,
  parameterDefinitions: addsApiParameterDefinitions,
  dataColors,
  apiNodeDefinitions,
};
