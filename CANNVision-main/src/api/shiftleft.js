...
export const createShiftLeftControlStates = ({
  blockCount = 4,
  blockLen = 2,
  srcStride = 0,
  dstStride = 0,
...
export const shiftLeftApiParameterDefinitions = [
  ...defaultApiParameterDefinitions,
  { id: 'scalarValue', label: 'shift-bit(位移)', min: 0, max: 15, defaultValue: 1 },
];

export const shiftLeftApiDefinition = {
  id: 'shiftleft',
  label: 'ShiftLeft',
  createControlStates: createShiftLeftControlStates,
  parameterDefinitions: shiftLeftApiParameterDefinitions,
  dataColors,
  apiNodeDefinitions,
};
